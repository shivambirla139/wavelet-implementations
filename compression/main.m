...
disp('Number of zeros for three-level wavelet threshold processing:');
res3=idwt2(ca3,ch3,cv3,cd3,'haar');

disp('Number of zeros for secondary wavelet threshold processing:');
res2=idwt2(res3,ch2,cv2,cd2,'haar');

disp('First-level wavelet threshold processing zero setting number:');
